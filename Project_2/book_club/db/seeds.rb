...
meeting1 = Meeting.create(date: "1/2/17", host: "Laura Goldstein", location: "Navy Yard", member_id: 1, book_id: 1, club_id: 1 )
meeting2 = Meeting.create(date: "3/26/17", host: "Susan Poklemba", location: "Adams Morgan", member_id: 2, book_id: 2, club_id: 1)
...
member2 = Member.create(name: "Susan Poklemba", email: "susan@email.com", street_address: "5 Columbia Road", city: "Washington", state: "DC", zip: "20005")
